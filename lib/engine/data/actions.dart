...
List<CardAction> events = [
  ...
  CardAction("Pay new clothes: -£150", () => Game.act.pay(PayType.pot, 150)),
...
List<CardAction> findings = [
  ...
  CardAction("Free out of prison card", () => Game.data.player.goojCards++),
  CardAction("Hospital bill: -100", () => Game.act.pay(PayType.pot, 100)),
  CardAction("Pay a fine: -10", () => Game.act.pay(PayType.pot, 10)),
  CardAction("Insurance bill: -50", () => Game.act.pay(PayType.pot, 50)),
  CardAction("Doctor bill: -50", () => Game.act.pay(PayType.pot, 50)),
  CardAction(
